...
import { EstablishmentConfigOld } from "./EstablishmentConfig";
...
export class EstablishmentOld {
  ...
  establishmentConfig: EstablishmentConfigOld;

  @ManyToOne(() => CompanyOld, (company) => company.establishments, {
    onDelete: "RESTRICT",
    onUpdate: "RESTRICT",
  })
  ...
  @OneToMany(() => ReservationOld, (reservation) => reservation.establishment)
